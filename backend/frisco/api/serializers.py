...
class QuestionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Question
        fields = ['id', 'question_position', 'text', 'type', 'weight', 'description', 'questionnaire_id', 'active', 'question_category_title']
    ...
    def to_representation(self, instance):
        ...
        if instance.type == 'multiple_choice' or instance.type == 'multiple_select':
            ...
            representation['options'] = [{'title':option.text, 'goto':option.goto, 'weight': option.weight} for option in options]
        else:
...
class ResponseSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Response
        fields = ['id', 'user_name', 'score', 'q_answered', 'user_email', 'status', 'last_edited', 'questionnaire', 'submission_date']
